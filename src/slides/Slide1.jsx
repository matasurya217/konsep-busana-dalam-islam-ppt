...
export default function Slide1({ isActive, direction }) {
  return (
    <Slide isActive={isActive} direction={direction}>
      <div className="relative w-full max-w-5xl mx-auto min-h-[80vh] md:h-[80vh] flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between w-full px-4 md:px-8 lg:px-16 z-10 mt-4 pb-12 md:pb-20 gap-6">
          {/* Text Content */}
          <div className="text-center lg:text-left flex flex-col items-center lg:items-start flex-1">
            <h1 className="text-hierarchy-title mb-1">
              <motion.span
                ...
                className="block font-light text-primary/80 text-4xl md:text-5xl lg:text-6xl mb-2 tracking-widest uppercase"
              >
                Konsep Berbusana
              </motion.span>
              <motion.span
            ...
            <motion.div
              ...
              className="h-[2px] bg-accent/60 my-4"
            />
            ...
            <motion.div
              ...
              className="mb-1"
            >
              <span className="text-accent text-sm md:text-base font-bold tracking-[0.2em] uppercase">Pendidikan Agama Islam</span>
            </motion.div>
            ...
            <motion.h2
              ...
              className="text-lg md:text-xl font-light text-primary-light italic mt-1 max-w-xl"
            >
        ...
        <motion.div
          ...
          className="static md:absolute md:bottom-12 w-full px-4 md:px-8 lg:px-16 flex flex-col sm:flex-row justify-center md:justify-start items-center sm:items-start gap-6 md:gap-12 lg:gap-16 text-sm text-primary-dark/60 font-medium tracking-wide uppercase mt-8 md:mt-0"
        >
